    ...
    <div class="container mt-5">
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class=" mb-4">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        ...
                        <a href="{{ route('payment.edit') }}" class="text-primary">変更する</a>
                    </div>
                </div>
            ...
            <div class="col-md-6 border">
                ...
                <div class=" mb-4">
                    <div class="card-body">
                        <p>購入代金 <span class="ms-4">¥1,200</span></p>
                    </div>
                </div>

                <div class=" mb-4">
                    <div class="card-body">
                        <p>支払方法 <span class="ms-4">クレジットカード</span></p>
                ...
                <form action="{{ route('purchase.process') }}" method="POST">
                    @csrf
                    <button type="submit" class="btn btn-primary w-100">購入する</button>
                </form>
            </div>
        </div>
    </div>
